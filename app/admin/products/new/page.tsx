...
export default function NewProductPage() {
  ...
  const [colors, setColors] = useState<string[]>(['aucune_couleur'])
    ...
    try {
      ...
      if (formData.subsubcategory) {
        const { data: subsubcategoryData } = await supabase
          .from("categories")
          .select("id")
          .eq("name", formData.subsubcategory)
          .single()
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <header className="bg-white border-b border-neutral-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-neutral-900">Créer un produit</h1>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 border border-neutral-200">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-900 mb-2">Télécharger des images</label>
              <input
                type="file"
                multiple
                accept="image/*"
              ...
              />
              <p className="text-sm text-neutral-600 mt-2">Vous pouvez télécharger plusieurs images</p>
            </div>
